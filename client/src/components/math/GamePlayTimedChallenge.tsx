...
// type GamePlayTimedChallengeProps = {
//   sliderValue: number;
...
//   isTimedChallengeModalOpen: boolean;
...
//   if (!isTimedChallengeModalOpen) return null;
